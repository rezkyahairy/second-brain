---
created: {{date}}T{{time}}
tags: [prompt, ai, process]
---

# Prompt: Process Inbox

> **DATE CHECK:** Use `{{date:YYYY-MM-DD}}` for current date.
> Reference: `.uteuk/skills/date-helper/DATE_CHECK.md`
...
- ALWAYS commit with FOOLPROOF method after approved moves (see `.uteuk/prompts/commit.md`)
